...
TIME_TABLES_FILENAME = 'time_tables.scv'
...
def creat_df_curr_positions_of_buses():
    ...
    data = [pd.json_normalize(bus_position) for bus_position in buses_position_data]
